...
# ใช้ลิงก์จาก GitHub Releases ตามที่คุณระบุ
...
# ใช้ -UserAgent และ -UseBasicParsing เพื่อให้การโหลดผ่าน Redirect ของ GitHub ทำงานได้สมบูรณ์
...
# ตรวจสอบว่ามีไฟล์ดาวน์โหลดมาจริงๆ ค่อยดำเนินการต่อ
if (Test-Path $exe) {
    ...
    Write-Host "ดาวน์โหลดไม่สำเร็จ กรุณาตรวจสอบการเชื่อมต่ออินเทอร์เน็ต" -ForegroundColor Red
}
